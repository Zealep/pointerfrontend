...
export class RequisicionPersonal {
  ...
  feCreacion!: Date
  ipCreacion!: string
  detalleRequisitos!: Blob
  detalleBeneficios!: Blob
  detalleFunciones!: Blob
  idModalidadTrabajo!: Datos
  detalleRequisitosHtml!: string
  detalleBeneficiosHtml!: string
  detalleFuncionesHtml!: string
}
